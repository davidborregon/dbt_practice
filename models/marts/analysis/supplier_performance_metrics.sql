select
    s.supplier_id,
    s.supplier_name,
    nr.country_name as supplier_nation,
    nr.region_name as supplier_region,
...
join {{ ref("int_nation_region") }} nr on s.country_id = nr.country_id
...
group by s.supplier_id, s.supplier_name, nr.country_name, nr.region_name
